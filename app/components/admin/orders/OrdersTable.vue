            ...
            >
              ...
              <td class="px-6 py-3.5">
                <div class="flex items-center gap-3">
                  ...
                  <div class="min-w-0">
                    <p class="text-sm font-medium text-zinc-700 truncate max-w-[160px]">{{ order.client }}</p>
                    <p v-if="order.email" class="text-xs text-zinc-400 truncate max-w-[160px]">{{ order.email }}</p>
                    <p v-if="order.phone" class="text-xs text-zinc-400 truncate max-w-[160px]">{{ order.phone }}</p>
                  </div>
                </div>
              </td>
