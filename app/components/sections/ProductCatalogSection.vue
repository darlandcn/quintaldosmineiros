...
<template>
  ...
  <section id="produtos" class="bg-[#F5EDD8] py-24 md:py-32">
    <div class="max-w-7xl mx-auto px-5 md:px-8">
      ...
      <!-- ─── CTA para Pedido via WhatsApp ─── -->
      <div class="mt-14 text-center">
        <p class="font-body text-sm text-[#7A6355] mb-5">
          Não viu o que procura? Fale diretamente conosco.
        </p>
        <a
          href="https://wa.me/5531999999999?text=Olá! Gostaria de conhecer os produtos do Quintal dos Mineiros."
          target="_blank"
          rel="noopener noreferrer"
          class="inline-flex items-center gap-2 bg-[#2C1810] text-white
                 px-8 py-3.5 rounded-full font-body font-semibold text-base
                 hover:bg-[#3D2B1F] transition-all duration-300 shadow-sm"
        >
          <!-- Ícone WhatsApp -->
